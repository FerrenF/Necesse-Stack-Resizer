...
public class AddBlacklistCommand extends ModularChatCommand {
	public AddBlacklistCommand() {
		super("iss.blacklist.add", "Add an item to the blacklist.", PermissionLevel.OWNER, false,new CmdParameter[]{
	...
	public void runModular(Client client, Server server, ServerClient serverClient, Object[] args, String[] errors,
			CommandLog logs) {			
		int result = (boolean)args[2] ? ModifyISS.addClassToBlacklist((String)args[0]) :
			ModifyISS.addItemToBlacklist((String)args[0]);
